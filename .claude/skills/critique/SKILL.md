...
name: critique
description: |
  Run an expert design review of a Forge artifact (a DS page, an example screen,
...
# Critique Skill · 5-Dimension Forge Review

Review a Forge artifact and score it across 5 dimensions, citing concrete
...
- After a Forge page/screen/component is built and someone asks "review this".
...
Does it commit to the Forge direction through every micro-decision? One ember
...
### 5. Innovation
Does it push past the median in a way that *serves* the Forge thesis (not
