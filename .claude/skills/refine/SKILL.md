...
- `.claude/skills/critique/SKILL.md` — the 5-dimension review lens
  (Philosophy / Visual hierarchy / Detail / Functionality / Innovation).
- `.claude/skills/tweaks/SKILL.md` — how to reason about parametric variants
  (accent, type scale, density, motion) before committing to one.
- `.claude/design-systems/forge/DESIGN.md` — the bar the artifact must hit.
- `.claude/craft/anti-ai-slop.md`, `accessibility-baseline.md`, `rtl-and-bidi.md`,
