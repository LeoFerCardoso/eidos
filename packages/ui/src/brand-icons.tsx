...
import {
  ...
  siWhatsapp, siTelegram, siImessage, siGooglechat,
} from 'simple-icons';
...
const EXTRA: Record<string, SI> = {
  ...
  twilio: {
    title: 'Twilio', hex: 'F22F46',
    path: 'M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.6 0 12 0zm0 21.6c-5.302 0-9.6-4.298-9.6-9.6S6.698 2.4 12 2.4s9.6 4.298 9.6 9.6-4.298 9.6-9.6 9.6zm5.994-13.194c0 1.323-1.073 2.396-2.396 2.396-1.324 0-2.397-1.073-2.397-2.396 0-1.324 1.073-2.397 2.397-2.397 1.323 0 2.396 1.073 2.396 2.397zm0 7.188c0 1.324-1.073 2.397-2.396 2.397-1.324 0-2.397-1.073-2.397-2.397 0-1.323 1.073-2.396 2.397-2.396 1.323 0 2.396 1.073 2.396 2.396zm-7.188 0c0 1.324-1.073 2.397-2.397 2.397-1.323 0-2.396-1.073-2.396-2.397 0-1.323 1.073-2.396 2.396-2.396 1.324 0 2.397 1.073 2.397 2.396zm0-7.188c0 1.323-1.073 2.396-2.397 2.396-1.323 0-2.396-1.073-2.396-2.396 0-1.324 1.073-2.397 2.396-2.397 1.324 0 2.397 1.073 2.397 2.397z',
  },
};
...
export const BRANDS: BrandDef[] = [
  ...
  fromSI(siWhatsapp, 'comms', 'whatsapp'),
  fromSI(siTelegram, 'comms', 'telegram'),
  fromSI(siImessage, 'comms', 'imessage', 'iMessage'),
  fromSI(siGooglechat, 'comms', 'google-chat', 'Google Chat'),
  fromExtra('twilio', 'comms', 'twilio'),
  // Project / docs
