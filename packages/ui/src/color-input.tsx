...
//
// State lives in HSV space — the geometry of the SV square and hue bar only
// makes sense there. RGB and hex are derived. No external colour library.
//
// CSS comes from the shared .cp-* block in packages/ui/styles/tokens.css.
// Do NOT add a <style> block here.
...
// ─── ColorPicker ─────────────────────────────────────────────────────────────
// The inline H/S/V picker — saturation/value square, hue bar, optional alpha
// bar, hex + RGB inputs, optional eyedropper, optional swatch palette.
...
// ─── ColorInput ───────────────────────────────────────────────────────────────
// The trigger: a checker-pattern swatch + hex code + chevron that opens
// ColorPicker in a position:fixed popover. The popover escapes overflow:hidden
// ancestors by computing placement from getBoundingClientRect().
//
// Controlled: pass `value` + `onChange`.
// Uncontrolled: pass `defaultValue` (state managed internally).
