...
// ArrowDown/Up moves the active option, Enter commits, Escape/Tab closes.
// Multi mode toggles selections and shows chips above the trigger.
//
// CSS classes live in packages/ui/styles/tokens.css (.cb-* block).
// No <style> block or CSS import here — just emit the className strings.
