...
// ═══════════════════════════════════════════════════════════════════════════
// Progress — linear bar, circular ring, segmented stepper.
//
// Variants: linear (default) | circular
// Modes:    determinate (value/max) | indeterminate (no value prop)
// Extras:   buffered (linear only), striped (linear only), segmented
//
// CSS: all visual rules live in ds.css under the .prog-* namespace.
// No Radix, no Tailwind — pure React + semantic CSS + cn().
// ═══════════════════════════════════════════════════════════════════════════

// ── Types ─────────────────────────────────────────────────────────────────

export type ProgressVariant = 'linear' | 'circular';
export type ProgressStatus = 'primary' | 'success' | 'warning' | 'danger' | 'neutral';
...
// ── ProgressCircular (internal — exported as Progress compound) ──────────
