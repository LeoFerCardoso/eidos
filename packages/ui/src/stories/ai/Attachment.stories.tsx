      ...
      <div style={{ maxWidth: 640 }}>
        ...
        >
          ...
          <ImageView
            ...
            caption="Generated from forge.yaml ring definitions · identity-svc · 2026-05-30"
            aspect="16 / 9"
          />
          <p>
      ...
      return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 32, maxWidth: 640 }}>
          ...
          <div>
            ...
            <Response
              meta={<span style={{ fontFamily: 'var(--font-mono)', fontSize: 11, color: 'var(--fg-muted)' }}>Forge AI · just now</span>}
            >
              <p>Here is the architecture diagram you requested:</p>
              <ImageView
                src={SVG}
                alt="Architecture diagram"
                caption="Generated by Forge AI · identity-svc · 2026-05-30"
                aspect="16 / 9"
              />
