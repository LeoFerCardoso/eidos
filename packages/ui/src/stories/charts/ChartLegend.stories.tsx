...
import { ChartLegend, EidosChart, Recharts } from '@eidos/ui';
    ...
    docs: {
      description: {
        component:
          ...
          'Intended for use above or below a <EidosChart> when the built-in Recharts legend ' +
          'does not match Eidos typography.',
      },
    },
  },
  args: {
...
/** In context — legend paired with a EidosChart multi-series line chart. */
export const InContext: Story = {
  parameters: { layout: 'padded' },
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
      <ChartLegend items={ITEMS} />
      <EidosChart title="Service health" height={240}>
