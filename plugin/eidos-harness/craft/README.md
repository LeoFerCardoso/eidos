...
generic hex, so they map directly onto Eidos's ember token.
...
| `rtl-and-bidi.md` | `rtl-and-bidi` | Any localizable text/layout (RTL is first-class in Eidos) |
...
Open Design distribution, with edits to point at Eidos's tokens
