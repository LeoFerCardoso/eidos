...
- Harness lives entirely in .claude/: Eidos-native skills in .claude/skills/, single canonical brand .claude/design-systems/forge/DESIGN.md, craft rulebooks .claude/craft/*, subagents .claude/agents/. Scope is DS / Harness / DevEx / IDP only. Catalog: FORGE-DS-REFERENCE.md + llms.txt.
