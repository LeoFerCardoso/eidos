...
4. `${CLAUDE_PLUGIN_ROOT}/design-systems/forge/DESIGN.md` — brand (ember budget, Geist, density, motion).
5. Craft: `${CLAUDE_PLUGIN_ROOT}/craft/{typography,color,anti-ai-slop,accessibility-baseline,rtl-and-bidi,state-coverage}.md`.
