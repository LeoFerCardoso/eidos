...
description: |
  ...
  into a concrete Eidos design brief expressed in Eidos terms — tokens,
...
guessing. Eidos already has a fixed design language — your job is **not** to
invent a palette or typography, but to decide how this specific UI uses the
existing Eidos tokens, components, and states.
...
each, cite the Eidos token/component rather than an abstract value.
...
2. **Resolve gaps with Eidos defaults** — for anything unspecified, choose the
   conservative Eidos default and *say so* (e.g. "density: balanced, default —
   ...
   Eidos language, push back rather than comply.
...
- **Don't invent the design language** — Eidos palette, ember accent, and Geist
