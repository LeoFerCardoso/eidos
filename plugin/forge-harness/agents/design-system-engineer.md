...
description: Use to author or modify Forge Design System components, pages, tokens, and example screens — the 3-file page ritual, ds.css/tokens.css discipline, charts, elements, AI surfaces, patterns. Use whenever the work touches src/ds/** or src/styles/**.
