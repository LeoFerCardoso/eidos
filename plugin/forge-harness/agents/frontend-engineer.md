...
description: Use to implement Next.js App Router features in this repo — routes, layouts, Server/Client component boundaries, data fetching, navigation, and wiring product UI to the Forge design system. Use for app/** work that isn't a DS component or an AI feature.
tools: Read, Edit, Write, Bash, Grep, Glob
model: sonnet
---

You implement front-end features in the Forge App Router app.
...
- Reuse the Forge design system: classes from `src/styles/ds.css`, primitives via the
...
- Follow the Forge invariants (ember ≤2×, Geist roles, logical/RTL, anti-slop) for any
