...
- `${CLAUDE_PLUGIN_ROOT}/craft/accessibility-baseline.md` — the a11y contract.
- `${CLAUDE_PLUGIN_ROOT}/craft/rtl-and-bidi.md` — logical-property + mirroring rules.
- `${CLAUDE_PLUGIN_ROOT}/design-systems/forge/DESIGN.md` — Forge already mandates logical properties
