...
const CHANGELOG: ChangelogEntry[] = [
  ...
  { version: 'v1.9.0', date: '2026-05-21', type: 'feat', scope: 'blocks', title: 'Forge Blocks launched at /blocks',
  ...
  { version: 'v1.9.0', date: '2026-05-21', type: 'breaking', scope: 'hero', title: 'Hero & Page headers moved here from IDP',
    summary: 'The section-level Hero and Page-headers recipes left IDP Elements (where they read as platform-only) and now anchor Forge Blocks alongside the new section recipes.' },
...
export default function BlocksChangelog() {
  return (
    <ChangelogView
      entries={CHANGELOG}
      title="Changelog"
      desc="Every change to Forge Blocks — searchable, filterable, scoped per block."
      dsName="Forge Blocks"
    />
  );
}
