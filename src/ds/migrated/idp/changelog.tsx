...
const CHANGELOG: ChangelogEntry[] = [
  ...
  { version: 'v1.9.0', date: '2026-05-21', type: 'feat', scope: 'idp', title: 'Forge IDP split into its own sub-DS at /idp',
  ...
  { version: 'v1.9.0', date: '2026-05-21', type: 'breaking', scope: 'blocks', title: 'Hero & Page headers left IDP for Forge Blocks',
    summary: 'The section-level Hero and Page-headers recipes moved out of IDP Elements into the new Forge Blocks sub-DS, where they sit alongside Feature grid / CTA banner / Stat band / Split feature.' },
...
export default function IdpChangelog() {
  return (
    <ChangelogView
      entries={CHANGELOG}
      title="Changelog"
      desc="Every change to Forge IDP — searchable, filterable, scoped per block."
      dsName="Forge IDP"
    />
  );
}
