      ...
      <div className="ds-frame">
        ...
        <div className="ds-frame-body" style={{ padding: '64px 36px 56px' }}>
          ...
          <div className="ana-list" style={{ maxWidth: 560, margin: '56px auto 0' }}>
            ...
            <span className="num">3</span><span><b style={{ color: 'var(--fg)' }}>Number / boolean value.</b> Cyan (<Mono>--accent-2</Mono>) for numerics, warm amber (<Mono>--warning</Mono>) for booleans. Each primitive type gets its own hue — not arbitrary, but mapped once in the inspector's token sheet so overrides are a one-line change.</span>
